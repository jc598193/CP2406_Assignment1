...
public class TrafficLight {
    ...
    public TrafficLight(String id, Road road) {
        ...
        position = this.roadAttachedTo.getEndLocation(); // always places the traffic light at the end of the roadAttachedTo.
    ...
    public void printLightStatus() {
        System.out.printf("%s is:%s on %s at position:%s%n", this.getId(), this.getState(), this.getRoadAttachedTo().getId(), Arrays.toString(this.getPosition()));
    }
